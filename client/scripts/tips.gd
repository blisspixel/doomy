...
const TIPS: Array[String] = [
	...
	"Pressing R does nothing yet. It will. There is a table with magazine sizes in it and everything.",
	...
	"There is no reload yet. There is a whole document explaining that there will be. The document is very good.",
