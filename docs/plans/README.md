...
| [`showcase-benchmark.md`](./showcase-benchmark.md) | **spec** | The benchmark measures a server already proven not to be the bottleneck. A client-side flow that pushes the machine, reads as a trailer, and reports frame-time statistics properly. |
