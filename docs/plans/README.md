...
| [`jammer-dish-unmissable.md`](./jammer-dish-unmissable.md) | **ready for PR** | Make jammer dish actually unmissable to stranger eyes; footprint harness + aimed proof stills. |
