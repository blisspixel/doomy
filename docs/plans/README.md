...
|---|---|---|
| [`decision-brain.md`](./decision-brain.md) | **in flight** | Decision-brain agent: Jev (TypeSafe or OpenRouter) sets intent a few times a second, local controller plays every tick, hard spend cap with a ledger. |
