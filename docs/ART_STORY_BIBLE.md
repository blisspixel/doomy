...
- Alt mark (square): `docs/fragr-logo-mark.jpg` - kept as secondary/app-icon candidate.
...
3. **Key art** - `fragr-keyart-hangar-candy.jpg` drops into fragr `docs/` via Buildy/Gitty (Nick approved vibe).
